...
/** Original animation used if video playback is unavailable. */
export const AD_FALLBACK_MEDIA_URL="/ads/casino-jackpot-storyboard.gif";
/** First animation frame, shown while the video starts loading. */
export const AD_POSTER_URL="/ads/casino-jackpot-poster.webp";
