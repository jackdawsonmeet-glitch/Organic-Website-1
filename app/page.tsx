...
export default function Home(){
 ...
 <section className="ad-slot referral-ad-zone">{doctorWebsite&&<a className="referral-hotspot referral-hotspot-2" href={doctorWebsite} aria-label="Visit Dr. Mayank Singh's website from section 2" title="Visit Dr. Mayank Singh"/>}{doctorWebsite&&<a className="referral-hotspot referral-hotspot-5" href={doctorWebsite} aria-label="Visit Dr. Mayank Singh's website from section 5" title="Visit Dr. Mayank Singh"/>}<span>ADVERTISEMENT</span>{advertisementWebsite?<a className="advertisement-link" href={advertisementWebsite} target="_blank" rel="sponsored noopener noreferrer" aria-label="Advertisement: Play Daily Letter — opens crosswordgameplay.netlify.app in a new tab">{advertisement}</a>:<figure className="advertisement-link" aria-label="Advertisement">{advertisement}</figure>}</section>
